            ...
            <Container>
                    <Form onSubmit={() => this.handleSubmit()}>
                        ...
                        <Form.Group controlId='formDescription'>
                            ...
                            <Form.Control ref={this.state.descriptionField} type="text" defaultValue={'replacewithredux'}>
                            </Form.Control>
                        </Form.Group>
                        <Form.Group controlId='formDescription'>
                            <Form.Label>
                            ...
                            <Form.Control ref={this.state.cuisineField} type="text" defaultValue={'replacewithredux'}>
                            </Form.Control>
                        </Form.Group>
                        <Form.Group controlId='formBeginHours'>
                            ...
                            <div style={{display: 'flex'}}>
                                ...
                                <Form.Control ref={this.state.beginHoursField} type="time" defaultValue={''}>
                                </Form.Control> 
                            </div>
                            <div style={{display: 'flex'}}>
                                <Form.Label>
                                ...
                                <Form.Control ref={this.state.endHoursField} type="time" defaultValue={''}>
                                </Form.Control>
                            </div>
                        </Form.Group>
                        <Form.Group controlId='formPhone'>
                            ...
                            <Form.Control ref={this.state.phoneField} type="text" defaultValue={'replacewithredux'}>
                            </Form.Control>
                        </Form.Group>
                        <Form.Group controlId='formCity'>
                            ...
                            <Form.Control ref={this.state.cityField} type="text" defaultValue={'replacewithredux'}>
                            </Form.Control>
                        </Form.Group>
