...
import { addItemToCart, removeItemFromCart, removeItemTypeFromCart } from '../../../Redux/ActionFiles/CustomerActions';
    ...
    render() {        
        return (
            <div className="listFood">
                <div>
                    {this.props.cartItem && this.props.cartItem.name}
                </div>
                <div>
                ...
                <div>
                    {this.props.cartItem && this.props.cartItem.quantity}
                </div>
...
const mapDispatchToProps = (dispatch: Dispatch<CartActions>): CartItemDispatchProps => ({
    addToCart: (item: MenuItem) =>
        dispatch(addItemToCart(item)),
    removeFromCart: (item: MenuItem) =>
        dispatch(removeItemFromCart(item)),
    removeTypeFromCart: (item: MenuItem) =>
        dispatch(removeItemTypeFromCart(item))
});

export const CustomerCartItem = connect(
    null,
    mapDispatchToProps
)(CartItem)