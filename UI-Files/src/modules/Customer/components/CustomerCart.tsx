...
import { OrderItem, CustomerInfo, Order } from '../../../Redux/InterfaceFiles/types';
import { CartState } from '../../../Redux/ReducerFiles/CustomerReducers/CartReducer';
import { RootState } from '../../../Redux/StoreFiles/store';
import { connect } from 'react-redux';
import { SendOrderThunkAction, sendOrder } from '../../../Redux/ActionFiles/CustomerActions';
...
class Cart extends React.Component<CustomerCartProps> {
    ...
    handleCheckout() {
        ...
        else if(!this.props.items || !this.props.price) console.log("Cart is empty!")
        else {
        ...
        return (
            <div>
                ...
                <ListGroup style={{padding: '2px'}}>
                    {this.props.items && this.props.items.map((item: OrderItem) => 
                        {
                            return (
                                <CustomerCartItem
                                    cartItem={item}
                ...
                <div className="centered">
                    <Row> 
                        ...
                        <Col xs={6}>
                            <Button variant="warning" onClick={() => this.handleCheckout()} style={{position: 'relative', bottom: '-20px', margin: 5, right: '-20px'}} type="button">Checkout</Button>
                        </Col>
                    </Row>
                </div>
            </div>
