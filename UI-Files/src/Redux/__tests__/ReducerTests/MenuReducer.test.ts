import {
  Menu,
  initState
} from "../../ReducerFiles/CustomerReducers/MenuReducer";
import {
  checkoutOrder,
  addItemToCart,
  removeItemFromCart
...
describe("The Menu Reducer", () => {
  it("should add a new item to the cart", () => {
    expect(Menu(cart_base_state_new, addItemToCart(menu_item_add_new))).toEqual(
      Object.assign({}, cart_base_state_new, {
        ...cart_base_state_new,
        cart: [
          {
            id: 1,
  ...
  it("should increase the quantity of an existing menu item", () => {
    expect(
      Menu(cart_base_state_existing, addItemToCart(menu_item_add_existing))
    ).toEqual(
      Object.assign({}, cart_base_state_existing, {
  ...
  it("should delete an item from the cart", () => {
    expect(
      Menu(cart_base_state_delete, removeItemFromCart(menu_item_delete))
    ).toEqual(
      Object.assign({}, cart_base_state_delete, {
