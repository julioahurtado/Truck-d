import { FETCH_ORDERS_STATUS, CANCEL_ORDER_STATUS, FINISH_ORDER_STATUS, FetchOrdersAction, CancelOrderAction, FinishOrderAction } from '../../ActionFiles/VendorActions';
...
export const Orders = (state: OrdersState = ordersState, action: OrderActions): OrdersState => {
    switch(action.type) {
