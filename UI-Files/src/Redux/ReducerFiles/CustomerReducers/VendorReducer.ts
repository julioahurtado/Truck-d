    import { UPDATE_VENDOR, GET_MENU_STATUS, UpdateVendorAction, GetMenuAction } from '../../ActionFiles/CustomerActions';
    ...
    export const Vendor = (state: VendorState = vendorState, action: UpdateVendorAction | GetMenuAction): VendorState => {
        switch(action.type) {
