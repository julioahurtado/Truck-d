...
export interface UpdateCustomerDetailAction {
    type: typeof UPDATE_CUSTOMER_NAME | typeof UPDATE_CUSTOMER_EMAIL | typeof UPDATE_CUSTOMER_PHONE,
    payload: string
};
...
export const updateCustomerName = (name: string): UpdateCustomerDetailAction => ({
    type: UPDATE_CUSTOMER_NAME,
    payload: name
});

export const updateCustomerEmail = (email: string): UpdateCustomerDetailAction => ({
    type: UPDATE_CUSTOMER_EMAIL,
    payload: email
});

export const updateCustomerPhone = (phone: string): UpdateCustomerDetailAction => ({
